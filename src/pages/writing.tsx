import { WritingScreen, WritingScreenProps } from "@/screens";
import { GetStaticProps } from "next";
import fs from "fs";
import path from "path";
import matter from "gray-matter";

export const getStaticProps: GetStaticProps<WritingScreenProps> = async () => {
  const fileNames = fs.readdirSync(path.resolve("src", "contents"));

  const posts: WritingScreenProps["posts"] = [];
